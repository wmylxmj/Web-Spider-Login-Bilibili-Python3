...
class BilibiliLogger(object):
    ...
    def __init__(self, username, password, windowsize=(750, 800)):
        '''
...
class BilibiliSpider(object):
    ...
    def login(self, username, password, windowsize=(750, 800), show_images=False):
        '''
        ...
        self.username = username
        self.password = password
        self.logger = BilibiliLogger(username, password, windowsize=windowsize)
...
bili = BilibiliSpider()
bili.login('18994091839', '106336213wmy', 'max')
